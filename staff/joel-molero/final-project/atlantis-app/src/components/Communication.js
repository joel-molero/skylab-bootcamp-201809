  ...
  <div className="auth">
    <div className="media-controls">
      ...
      <button onClick={props.toggleAudio} className={'audio-button-' + props.audio}>
        <svg    viewBox="0 0 50 50" className="svg">
    ...
    <div className="grant-access">
      ...
      <div className="request-message" dangerouslySetInnerHTML={props.getContent(props.message)}></div>
      <button onClick={props.handleInvitation} data-ref="reject" className="primary-button-access">Reject</button>
      <button onClick={props.handleInvitation} data-ref="accept" className="primary-button-access">Accept</button>
    </div>
